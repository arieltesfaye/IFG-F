...
<html lang="en">
    ...
    <body>
        ...
        <!-- Single Post Start-->
        <div class="climateactionsingle" id="climate-action">
            <div class="container">
                <div class="row">
                    <!-- Climate Section -->
        ...
        <div class="edinitiativesingle" id="education-initiatives">
            <div class="container">
                <div class="row">
                    <!-- Education Section -->
                    <div class="single-content" >
        ...
        <div class="healthcaresingle" id="healthcare-programs">
            <div class="container">
                <div class="row">
                    <!-- Healthcare Programs -->
                    <div class="single-content">
                        ...
                        <h4>Get Involved</h4>
                        <p>Help us expand our healthcare reach. <a href="donate">Donate today</a> to support IFG’s healthcare programs.</p>
                    </div>
                </div>
            </div>
        </div>

        <div class="socialempowermentsingle" id="social-empowerment">
            <div class="container">
                <div class="row">
                    <!-- Social Empowerment -->
                    <div class="single-content" >
                        ...
                        <p>Social empowerment is at the heart of IFG’s mission. We believe that true change happens when communities are empowered to lead their own development. Our social empowerment programs are designed to provide resources, training, and support for women, youth, and marginalized groups, helping them build independence and resilience.</p>
                        <p>From small business grants to skills training, IFG supports initiatives that help individuals develop economic stability and self-confidence. In partnership with local leaders and organizations, we have launched women’s cooperatives, youth mentorship programs, and advocacy workshops aimed at amplifying voices that are often unheard.</p>
        ...
        <div class="communitydevelomentsingle" id="community-development">
            <div class="container">
                <div class="row">
                    ...
                    <div class="single-content">
                        ...
                        <p>At IFG, we are committed to the sustainable growth of communities, working closely with residents to build the infrastructure and resources needed for long-term prosperity. Our community development programs focus on improving access to clean water, sanitation, sustainable agriculture, and renewable energy.</p>
                        ...
                        <h2>Help Us Grow</h2>
                        <p>Your generosity fuels community growth. <a href="donate">Donate now</a> to support IFG’s community development efforts.</p>
                    </div>
                    <!-- Tags Section -->
                ...
                <div class="row">
                    ...
                    <div class="single-bio">
                        ...
                        <div class="single-bio-text">
                            <h3>Atieno Sigana</h3>
                            <p>
                                Atieno Sigana is the Secretary of IFG and an advocate for climate justice. She has been instrumental in driving grassroots initiatives that empower communities to take charge of their futures.
                            </p>
                        </div>
                    </div>
                ...
                <div class="comment-section-wrapper">
                    ...
                    <form>
                        <div class="comment-input-group">
                            <input type="text" class="comment-text-input" placeholder="Your Name" required>
                        </div>
                        <div class="comment-input-group">
                            <input type="email" class="comment-text-input" placeholder="Your Email" required>
                        </div>
                        <div class="comment-input-group">
                            <textarea class="comment-text-input comment-textarea" placeholder="Your Comment" required></textarea>
                        </div>
